...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes = 10):
        ...
        # from resnet paper architecture...
    ...
    def _make_layer(self, block, output_channels, blocks, stride=1):
        ...
        # we want to use bottleneck when the stride is not 1, and input_channels doesn't match output_channels
        # so our dimensions match
        ...
        # create the res blocks in the layer
